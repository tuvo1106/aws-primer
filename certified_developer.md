...
- [Elastic Beanstalk Follow Along](#elastic-beanstalk-follow-along)
  ...
  - [Elastic Container SService](#elastic-container-service)
...
- **.extensions** is a hidden folder called at the root of your project which contains the config files
- **.config** is the extension for the config files which need to be stored in extensions
...
0. Before we start, make sure to create an ECR Repository in the console which would look something like `<your-account-number>.dkr.ecr.us-east-1.amazon.com/<add-your-project-name-here>`
